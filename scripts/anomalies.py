...
def ResetSim(node):
    ...
    req.scope = ResetSimulation.Request.SCOPE_SPAWNED  # Reset everything in the simulation
...
def Spawn(node, objectType='carrot', name = "ANOMALY_Carrot", x = 1.5, y = 0.0, z = 0.2, frame_id = "egobase_link"):
...
def main():
    ...
    for i in range(20):
        Spawn (node, 'carrot', f'ANOMALY_GreenCube_{i}', x= 1.5 , y= 0.0, z= 0.2+i*0.01, frame_id = "egobase_link")
    time.sleep(5)
