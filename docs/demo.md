...
For setup details or if you need to rerun the demo, refer to the [setup instructions](setup.md) and [running instructions](running.md).

Looking for more depth? Read the [technical overview](technical_overview.md) for the architecture rundown and check out the [tutorials](tutorials.md) to extend the demo.
