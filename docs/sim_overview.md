...
- **ROS2 Scripts Integration**: Gem that allows to publish and subscribe to a limited set of ROS 2 messages using ScriptCanvas or LUA scripting language.
...
- **WarehouseAssets**: Gem that provides a variety of warehouse assets for building simulation environments.
...
This component simulates a 3D LiDAR sensor and publishes `sensor_msgs/LaserScan`.
